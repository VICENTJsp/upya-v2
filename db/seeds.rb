...
# ARTICLES
article1 = Article.create!(step_id: step1.id,title: "Article pour le step 1 - Lorem ipsum", description: "Short description of the article", content: "Lorem ipsum")

# VIDEOS
video1 = Video.create!(step_id: step1.id, title: "Video pour le step 1 - Lorem ipsum", description: "Short description of the video", url: "https://www.youtube.com/watch?v=MLntp09G0-g")

# COACHS
coach1 = Coach.create!(name: "George", email: "goerge@coach.com", category: "Bilan professionnel", description: "Short description of the coach", price_hour: 50)
